    ...
    <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
      ...
      <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-3">
          ...
          <select id="estado_id" name="estado_id" v-model="localData.estado_id" autocomplete="off"
        ...
        <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-3">
          <label for="espacio_id" class="block text-sm font-medium text-gray-700">Espacio</label>
          <select id="espacio_id" name="espacio_id" v-model="localData.espacio_id" autocomplete="off"
            :class="input_disable ? bg_disable : ''" :disabled="input_disable"
            class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none inline-flex focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            <option value="" disabled>
...
export default {
  ...
  methods: {
    updateParent() {
      this.$emit('data_gabinete', this.localData);
    }
  }
};
</script>
