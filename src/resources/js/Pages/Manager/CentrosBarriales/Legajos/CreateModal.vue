                                ...
                                <div class="px-1">
                                    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                                        <div class="px-4 py-5 sm:px-6">
                                            ...
                                            <p class="mt-1 max-w-2xl text-sm text-gray-500">Formulario de inscripción a
                                                Programas Sociales y Actividades</p>
                                        </div>
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        <div
                                                            ...
                                                            <input v-model="selectedOption"
                                                                :checked="selectedOption === 'programa_social'"
                                                                id="programa_social" type="radio" value="programa_social"
                                                                name="bordered-radio"
                                                        ...
                                                        <div
                                                            class="flex items-center justify-center border border-gray-200 rounded dark:border-gray-700">
                                                            <input v-model="selectedOption"
                                                                :checked="selectedOption === 'actividades'" id="actividades"
                                                                type="radio" value="actividades" name="bordered-radio"
                                                                class="ml-4 rounded-md w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                            ...
                                            <dl class="sm:divide-y sm:divide-gray-200">
                                                <div class="bg-white pt-5 pb-6 mt-2 px-4">
                                                    ...
                                                    <div class="grid grid-cols-5 gap-4 pt-5"
                                                        v-if="selectedOption === 'programa_social'">
                                                        <label for="first-name"
                                                            class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">Programa
                                                            Social: </label>
                                                        <div class="mt-1 col-span-4">
                                                            <select v-model="form.programa_social_id"
                                                                id="programa_social_id" name="programa_social_id"
                                                                ...
                                                                <option v-for="p in programasSociales" :key="p.id"
                                                                    :value="p.id">
                                                                    {{ p.description ?? '' }}
                                                                </option>
                                                            </select>
                                                    ...
                                                    <div class="grid grid-cols-5 gap-4 pt-5"
                                                        v-if="selectedOption === 'actividades'">
                                                        <label for="first-name"
                                                            class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">Actividades:
                                                        </label>
                                                        <div class="mt-1 col-span-4">
                                                            <select v-model="form.actividad_id" id="actividad_id"
                                                                name="actividad_id" autocomplete="off"
                                                    ...
                                                    <div class="grid grid-cols-5 gap-4 pt-5"
                                                        ...
                                                        <div class="mt-1 col-span-4">
                                                            <select v-model="form.profesional_id" id="profesional_id"
                                                                name="profesional_id" autocomplete="off"
                                                                :class="input_disable ? bg_disable : ''"
                                                                :disabled="input_disable"
                                                                class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none inline-flex focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                <option value="" disabled>
