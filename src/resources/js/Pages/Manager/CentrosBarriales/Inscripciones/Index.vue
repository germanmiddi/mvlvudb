        ...
        <div class="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
            <div class="flex-1 min-w-0">
                <h1 class="text-lg font-medium leading-6 text-gray-900 sm:truncate">
                    Inscripciones Centros Barriales
                </h1>
            </div>
                ...
                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        <div class="col-span-12 sm:col-span-1 ">
                            <label for="inscripcion_id" class="block text-sm font-medium text-gray-700">N° Inscripción</label>
                            <input v-model="filter.inscripcion_id" type="number" name="inscripcion_id" id="inscripcion_id" autocomplete="name-level2"
                        ...
                        <div class="col-span-12 sm:col-span-3">
                            <label for="fecha" class="block text-sm font-medium text-gray-700">Fecha Inscripcion</label>
