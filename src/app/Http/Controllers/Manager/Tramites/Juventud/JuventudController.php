    ...
    public function create()
    {
        return Inertia::render(
            ...
            [
                ...
                'escuelasPrimarias' => Escuela::where('primaria', true)->where('dependencia_id', 12)->get(),
                'escuelasSecundarias' => Escuela::where('secundaria', true)->where('dependencia_id', 12)->get(),
                'escuelasNocturnas' => Escuela::where('nocturna', true)->where('dependencia_id', 12)->get(),
