                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 sm:col-span-4 lg:col-span-3">
                            <label
                                for="gabinete_id"
                                class="block text-sm font-medium text-gray-700"
                                >Participa Emprend.</label
                            >
                            <Switch
                                v-model="filter.emprendedores"
                                @click="
                                    filter.emprendedores = !filter.emprendedores
                                "
                                :class="
                                    filter.emprendedores
                                        ? 'bg-blue-600'
                                        : 'bg-gray-200'
                                "
                ...
                >
                    ...
                    >
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            >
                                <tr
                                    v-for="data in legajos.data"
                                    :key="data.id"
                                    class="hover:bg-gray-50"
                                >
                                    <td
                                        class="px-6 py-3 whitespace-nowrap text-xs text-gray-500"
                                    >
                                        <p>
                                    ...
                                    <td
                                        class="hidden px-6 py-3 whitespace-nowrap text-xs text-gray-500"
                                    >
                                        {{
                                            formatNumberWithDots(
                                                data.person?.num_documento
                                        ...
                                        <Menu as="div" class="inline-node">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <p
                                                            class="text-xs text-indigo-500 font-bold mt-1"
                                                        >
                                                            Cambiar Estado:
                                                        </p>
                                                        <MenuItem
