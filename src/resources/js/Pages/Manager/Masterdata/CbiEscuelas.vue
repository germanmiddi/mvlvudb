            ...
            <div>
                ...
                <div v-if="showNew" class="my-5">
                    ...
                    <div class="flex mt-4">
                        ...
                        <input v-model="turnos.primaria" id="turnos_primaria" type="checkbox" value="1" class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="red-checkbox" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Primaria</label>
                    </div>
                    <div class="flex items-center mr-4">
                        <input v-model="turnos.secundaria" id="turnos_secundaria" type="checkbox" value="2" class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 rounded focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="green-checkbox" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Secundaria</label>
                    </div>
                    <div class="flex items-center mr-4">
                        <input v-model="turnos.nocturna" id="turnos_nocturna" type="checkbox" value="3" class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
