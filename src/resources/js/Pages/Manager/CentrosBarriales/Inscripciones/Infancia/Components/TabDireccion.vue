    ...
    <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
      ...
      <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-2">
          ...
          <input v-model="localData.piso" type="text" name="piso" id="piso" autocomplete="off" :disabled="input_disable"
        ...
        <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-2">
          ...
          <input v-model="localData.dpto" type="text" name="dpto" id="dpto" autocomplete="off" :disabled="input_disable"
            :class="input_disable ? bg_disable : ''"
            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
        </div>
      </div>
...
export default {
  ...
  methods: {
    updateParent() {
      this.$emit("data_direccion", this.localData);
    },
  },
};
</script>
