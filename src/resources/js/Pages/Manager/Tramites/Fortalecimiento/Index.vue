        ...
        <div class="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
            ...
            <div v-if="formImport" class="mt-4 flex sm:mt-0 sm:ml-4">
                ...
                <a  @click="importFile()" v-if="!processImport"
                    class="order-0 inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:order-1 sm:ml-3">Subir Archivo</a>
                ...
                <a @click="formImport=false"
                        class="order-0 inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:order-1 sm:ml-3">Cancelar</a>
            </div>
...
export default {
    ...
    methods: {
        ...
        async getTramites() {
            ...
            const get = `${route('fortalecimiento.list')}?${filter}`
