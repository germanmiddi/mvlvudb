    ...
    <main class="flex-1 bg-gray-50 pb-40">
        ...
        <div class="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
            <div class="flex-1 min-w-0 flex items-center">
				...
				<h1 class="text-lg font-medium leading-6 text-gray-900 sm:truncate">Nuevo Tramite Fortalecimiento Comunitario</h1>
            </div>
				...
				<div class="bg-white py-6 px-4 space-y-6 sm:p-6">
					...
					<div class="grid grid-cols-12 gap-6">
						<div class="col-span-12 sm:col-span-12 ">
							...
							<div class="flex ">
								<input v-model="form.description_file" type="text" name="descripcion" id="descripcion" autocomplete="descripcion-level2" 
...
export default {
	...
	methods: {
		...
		async submit() {
			...
			let rt = route('fortalecimiento.store');
