                ...
                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 sm:col-span-3">
                            ...
                            >
                            <select
                                v-model="filter.barrio"
                                id="barrio_id"
                                name="barrio_id"
                                autocomplete="barrio_id-name"
                                :disabled="
                                    barriosComputed.length === 0 ||
                                    input_disable
                                "
                                :class="
                                    barriosComputed.length === 0 ||
                            ...
                            >
                                ...
                                <option
                                    v-for="barrio in barriosComputed"
                                    :key="barrio.id"
                                    :value="barrio.id"
                                >
                                    {{ barrio.description }}
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div>
                                Mostrando: {{ this.persons.from }} a
                                {{ this.persons.to }} - Entradas encontradas:
                                {{ this.persons.total }}
                            </div>

                            <div class="flex flex-wrap -mb-1">
                                <div
                                    v-for="link in persons.links"
                                    :key="link.url"
                                >
                                    <div
                                        v-if="link.url === null"
                                    ...
                                    <div
                                        ...
                                        "
                                        @click="getPersonsPaginate(link.url)"
                                        v-html="link.label"
                                    ></div>
                                </div>
                            </div>
