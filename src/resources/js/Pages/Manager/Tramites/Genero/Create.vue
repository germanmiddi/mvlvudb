				...
				<div class="shadow sm:rounded-md sm:overflow-hidden">
					<div class="bg-white py-6 px-4 space-y-6 sm:p-6">
						...
						<div class="grid grid-cols-12 gap-6">
							...
							<div class="col-span-12 sm:col-span-3">
								<label for="aut_firmada" class="block text-sm font-medium text-gray-700">Ingreso
									Nuevo</label>
						...
						<div class="grid grid-cols-12 gap-6">
							...
							<div class="col-span-12 sm:col-span-3">
								...
								<select v-model="form.parentesco_id" id="parentesco_id" name="parentesco_id"
									autocomplete="parentesco_id-name" :disabled="input_disable"
						...
						<div class="grid grid-cols-12 gap-6">
							<div class="col-span-12 sm:col-span-3">
								...
								<select v-model="form.nivel_educativo_id" id="nivel_educativo_id"
									name="nivel_educativo_id" :disabled="input_disable"
									:class="input_disable ? bg_disable : ''" autocomplete="nivel_educativo_id-name"
									class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
									<option disabled value="">
