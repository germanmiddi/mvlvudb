...
<template>
    <div class="px-4 mt-6 sm:px-6 lg:px-8">
            ...
            <div class="">
                <dl>
                    ...
                    >
                        ...
                        >
                            {{ person?.address?.[0]?.calle || "" }}
                            {{ person?.address?.[0]?.number || "" }} -
                            {{
        ...
        <!-- Mensaje de error cuando no puede recibir cajas -->
        <div
            v-if="!canGetBox.status"
            class="mt-5 bg-red-50 border border-red-200 rounded-lg p-6"
        >
        ...
        <div
            v-if="canGetBox.status"
            class="mt-5 bg-white shadow overflow-hidden sm:rounded-lg"
        >
            <div class="px-4 py-5 sm:px-6">
        ...
        <div v-if="canGetBox.status && puntosEntrega.length !== 0" class="mt-6">
