    ...
    <div class="shadow sm:rounded-md sm:overflow-hidden mt-6">
        <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
            ...
            <div class="grid grid-cols-12 gap-6">
              ...
              <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-3">
                <label for="fecha_libreta_vacunacion" class="block text-sm font-medium text-gray-700">Fecha libreta de vacunación</label>
                <Datepicker
                  class="mt-1 focus:ring-red-500 focus:border-red-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                  v-model="localData.fecha_libreta_vacunacion"
                  :disabled="input_disable" :class="input_disable ? bg_disable : ''"
                  :enableTimePicker="false" :monthChangeOnScroll="false" autoApply :format="format">
                </Datepicker>
              </div>
            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 sm:col-span-9 md:col-span-9 xl:col-span-9">
                  <label for="programa_social_id" class="block text-sm font-medium text-gray-700">Observación de salud</label>
                  <div class="mt-1">
