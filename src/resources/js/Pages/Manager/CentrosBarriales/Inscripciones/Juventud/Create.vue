<template>
	<main class="flex-1 bg-gray-50 pb-40">
		...
		<div class="px-4 mt-6 sm:px-6 lg:px-8">
			<div class="border-b border-gray-200 dark:border-gray-700">
				<ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
					...
					<li class="me-2">
						<a href="#" @click="input_disable ? requiredPerson() : this.tabs = 7"
							:class="this.tabs === 7 ? 'border-blue-600 text-blue-600 dark:text-blue-500 dark:border-blue-500' : 'hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'"
							class="inline-flex items-center justify-center p-4 border-b-2 rounded-t-lg group">
							Emprendedor
						</a>
					</li>
			...
			<form action="#" method="POST" enctype="multipart/form-data" class="relative">
				...
				<TabEducacion v-if="this.tabs === 5" :form="form.educacion" :input_disable="input_disable"
					:nivelesEducativo="nivelesEducativo" :estadosEducativo="estadosEducativo"
					:turnosEducativo="turnosEducativo" :escuelas="escuelas" :escuelasDependencia="escuelasDependencia"
					:localidades="localidades" :escuelasNivel="escuelasNivel" @submit="handleEducacion">
				</TabEducacion>
				...
				<!-- EMPRENDEDOR -->
				<TabEmprendedor v-if="this.tabs === 7" :form="form.emprendedor" :input_disable="input_disable"
		...
		<DialogModal :show="showConfirmed" :title="modalTitle" :message="modalMessage" :type="modalType"
			@confirmModal="confirmModal" @closeModal="closeModal" />
	</main>
</template>
